...
abstract class Persona{
    ...
    public function __construct($dni,$nombre,$correo,$celular)  //se lo crea para usar parent::
    {
        $this->dni=$dni;
        $this->nombre=$nombre;
        $this->correo=$correo;
...
class Entrenador extends Persona{
    ...
    class Alumno extends Persona{
       ...
       private $peso;
       private $altura;
       private $bAptoFisico;        //es boolean
       private $presentismo;

       public function __construct($fechaNac,$dni,$nombre,$correo,$celular)
       {
        parent::__construct($dni,$nombre,$correo,$celular); //muestro lo hererado de Persona
       ...
       public function setAptoFisico($peso,$altura,$bAptoFisico)
       {
        $this->peso=$peso;
        $this->altura=$altura;
   ...
   class Clase{
    ...
    echo "<tr><th>NOMBRE</th><th>CORREO</th><th>CELULAR</th><td><b>DNI</b></th></tr>";
